...
In addition to the below information, features which are built on top of SetupTools framework will be documented in other files (example: character sorting lists existing on `setuptools.data.muledump.chsortcustom`).
