        ...
        req.always(function() {
        	...
        	if ( errDesc == 'timeout' ) {
                ...
                setuptools.app.ga('send', 'event', {
                    eventCategory: 'muledump',
                    eventAction: 'detect',
                    eventLabel: 'export-imgur-networkError'
                });
                ...
                setuptools.app.ga('send', 'event', {
                    eventCategory: 'muledump',
                    eventAction: 'detect',
                    eventLabel: 'export-imgur-httpError'
                });
...
function render_totals(callback) {
    ...
    if (!sourceImage) {
        ...
        sourceImage.src = ( window.RemoteRendersURL ) ? window.RemoteRendersURL : "https://jakcodex.github.io/muledump/lib/renders.png";
    ...
    img.onerror = function() {
        ...
        setuptools.app.ga('send', 'event', {
            eventCategory: 'muledump',
            eventAction: 'detect',
            eventLabel: 'export-image-loadError'
        });
