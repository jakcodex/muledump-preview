...
// dom snippet generators
    ...
    function addmulemenu(mule) {
        ...
        var menu = $('<div class="button noselect" title="Mule Menu">');
        menu.html('&#8801;');
        menu.click(function() {

            if ( setuptools.lightbox.menu.context.isOpen(muleId) === true ) {
            ...
            setuptools.lightbox.menu.context.create(muleId, false, $(this), options, $(this));
