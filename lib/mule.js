    ...
    Mule.prototype.query = function(ignore_cache, cache_only) {
        ...
        function onFail() {
            ...
            if (self.fails < 5) {
                ...
                //  help the user with potential cors issues (maybe network, or otherwise)
                if ( setuptools.tmp.corsAttempts > setuptools.config.muledump.corsMaxAttempts ) setuptools.app.muledump.corsAssist();
            }
        }
