        ...
        if ( setuptools.app.checknew() === true ) {
            ...
            if ( setuptools.config.devForcePoint !== 'bad-config' && setuptools.data.config.enabled === false ) {
                ...
                $('#totals').css({'max-width': ( (setuptools.data.config.totalswidth === 0) ?
                    (setuptools.config.totalsItemWidth*(Math.floor(($(window).innerWidth()-30)/setuptools.config.totalsItemWidth)))-setuptools.config.totalsItemWidth :
                    setuptools.data.config.totalswidth*setuptools.config.totalsItemWidth
                )});
