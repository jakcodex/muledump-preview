...
setuptools.config.githubRawUrl = 'https://raw.githubusercontent.com/jakcodex/muledump-preview';
...
setuptools.config.updatecheckURL = 'https://api.github.com/repos/jakcodex/muledump-preview/tags';
setuptools.config.updatecheckTTL = 30000;
setuptools.config.totalsItemWidth = 44;
setuptools.config.ga = 'UA-111254659-2';
setuptools.config.gaAppName = 'muledump-local';
