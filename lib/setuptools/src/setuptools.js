...
setuptools.config.totalsFilterKeysIndex = 8;
setuptools.config.totalsSaveKeys = ['totalsGlobal', 'famefilter', 'fameamount', 'feedfilter', 'feedpower', 'sbfilter', 'utfilter', 'stfilter'];
