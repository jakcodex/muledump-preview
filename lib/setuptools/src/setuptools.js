...
setuptools.config.totalsSaveKeys = ['totalsGlobal', 'famefilter', 'fameamount', 'feedfilter', 'feedpower', 'sbfilter', 'utfilter', 'stfilter', 'totalsTypesWeapons', 'totalsTypesAbilities', 'totalsTypesArmor', 'totalsTypesRings', 'totalsTypesPotions', 'totalsTypesKeys', 'totalsTypesSkins', 'totalsTypesTextiles', 'totalsTypesSwords', 'totalsTypesDaggers', 'totalsTypesBows', 'totalsTypesTomes', 'totalsTypesShields', 'totalsTypesLightArmor', 'totalsTypesHeavyArmor', 'totalsTypesWands', 'totalsTypesSpells', 'totalsTypesSeals', 'totalsTypesCloaks', 'totalsTypesRobes', 'totalsTypesQuivers', 'totalsTypesHelms', 'totalsTypesPoisons', 'totalsTypesStaves', 'totalsTypesSkulls', 'totalsTypesTraps', 'totalsTypesOrbs', 'totalsTypesPrisms', 'totalsTypesScepters', 'totalsTypesKatanas', 'totalsTypesStars', 'totalsTypesStatBoosters', 'totalsTypesDrakeEggs', 'totalsTypesEggs'];
...
setuptools.data.config.lazySave = 60000;
