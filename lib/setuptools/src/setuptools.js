...
setuptools.config.totalsFilterKeysIndex = 9;
setuptools.config.totalsSaveKeys = ['totalsGlobal', 'famefilter', 'fameamount', 'feedfilter', 'feedpower', 'sbfilter', 'nonsbfilter', 'utfilter', 'stfilter'];
