...
setuptools.app.backups.upload = function(manual) {
    ...
    setuptools.lightbox.build('backups-upload', ' \
        ...
        <br><div class="setuptools link backups uploadData save menuStyle cfright noclose">Select a File</div> \
    ');
            ...
            if ( BackupData = JSON.parse(BackupFile) ) {
                ...
                if ( badEntries.length > 0 && BadEntriesForce !== true ) {
                    ...
                    setuptools.lightbox.build('backups-restore-confirmed', ' \
                        ...
                        <a href="#" class="setuptools link backups restoreCancelled menuStyle negative cfright" style="width: 150px;">Cancel</a> \
                    ');
...
setuptools.app.backups.restoreConfirm = function(BackupID, BackupName) {
    ...
    setuptools.lightbox.build('backups-restore-confirm', ' \
        ...
        <br><br>\
            <div class="setuptools link backups restoreConfirmed menuStyle cfleft" style="width: 150px; margin-bottom: 10px;">Yes, restore</div> \
            <div class="setuptools link backups restoreCancelled menuStyle negative cfright" style="width: 150px; margin-bottom: 10px;">Cancel</div> \
    ');
