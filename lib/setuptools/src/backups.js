...
setuptools.app.backups.index = function() {
    ...
    if ( setuptools.state.loaded === true ) {
        ...
        setuptools.lightbox.build('backups-index', ' \
            <div style="float: left; clear: both; width: 100%; margin-bottom: 16px;">\
                <div class="setuptools link backups create menuStyle cfleft" style="width: 150px; text-align: center;">Create New Backup</div> \
                <div class="setuptools link backups upload menuStyle fleft" style="width: 150px; text-align: center;">Upload Backup</div> \
                <div style="width: 150px; text-align: center; margin-right: 0;" class="setuptools link backups autobackups noclose fleft menuStyle ' + ( (setuptools.data.config.automaticBackups === true) ? 'negative">Disable' : 'positive">Enable' ) + ' Auto Backups</div> \
            </div>\
        ');
        ...
        setuptools.lightbox.build('backups-index', ' \
            <div class="setuptools link backups upload menuStyle fleft" style="clear: both; width: 150px; text-align: center; margin-bottom: 16px;">Upload Backup</div> \
        ');

    }

    setuptools.lightbox.build('backups-index', ' \
        <div class="fleft" style="clear: both; width: 100%;">\
    ');
    ...
    if ( BackupList.length === 0 ) {
        ...
        setuptools.lightbox.build('backups-index', ' \
                <h3 class="fleft" style="clear: both; margin: 0 0 10px 0;">Stored Backups</h3> \
                <div class="cfleft" style="width: 100%;">\
                    <div class="cfleft" style="margin-right: 5px;">\
                        <select name="BackupName" class="setting" style="width: 295px;">\
        ');
        ...
        setuptools.lightbox.build('backups-index', ' \
                    ...
                    <div class="cfleft" style="margin-top: 10px;"> \
                        <div class="setuptools link backups download menuStyle" title="Download Backup" style="width: 70px; text-align: center;">Download</div> \
                        <div class="setuptools link backups restore menuStyle" title="Restore Backup" style="width: 70px; text-align: center;">Restore</div> \
                        <div class="setuptools link backups protect menuStyle" title="" style="width: 70px; text-align: center;">&nbsp;</div> \
                        <div class="setuptools link backups delete menuStyle negative" title="Delete Backup" style="width: 70px; text-align: center;">Delete</div> \
                    </div> \
                </div>\
            </div> \
        ');
    ...
    function bindDelete() {
        ...
        $('.setuptools.link.backups.delete').unbind('click');
        $('.setuptools.link.backups.delete').click(function() {
    ...
    function updateProtection() {
        ...
        if ( typeof SelectedBackupData === 'object' && SelectedBackupData.meta ) {
            ...
            if ( SelectedBackupData.meta.protected === false ) {
                ...
                $('.setuptools.link.backups.delete').removeClass('deleteDisabled noclose disabled truly').attr('title', 'Delete Backup');
                bindDelete();
                ...
                $('.setuptools.link.backups.delete').addClass('deleteDisabled noclose disabled truly')
                    .unbind('click')
            ...
            $('.setuptools.link.backups.protect').click(function() { setuptools.app.backups.examine(SelectedBackupID); });
...
setuptools.app.backups.upload = function(manual) {
    ...
    setuptools.lightbox.build('backups-upload', ' \
        ...
        <br><div class="setuptools link backups uploadData save menuStyle cfright noclose" style="margin-right: 0;">Select a File</div> \
    ');
    ...
    if ( DoFiles === true ) {
        ...
        $('.setuptools.bottom.container').append(' \
            <div style="clear: right; float: right; height: 100%; margin-top: 3px;"> \
            ...
            if ( BackupData = JSON.parse(BackupFile) ) {
                ...
                if ( badEntries.length > 0 && BadEntriesForce !== true ) {
                    ...
                    setuptools.lightbox.build('backups-restore-confirmed', ' \
                        ...
                        <a href="#" class="setuptools link backups restoreConfirmed menuStyle cfleft" style="width: 150px;">Yes, restore</a> \
                        <a href="#" class="setuptools link backups restoreCancelled menuStyle negative cfright" style="width: 150px; margin-right: 0;">Cancel</a> \
                    ');
...
setuptools.app.backups.restoreConfirm = function(BackupID, BackupName) {
    ...
    setuptools.lightbox.build('backups-restore-confirm', ' \
        ...
        <br><br>\
            <div class="setuptools link backups restoreConfirmed menuStyle cfleft" style="width: 150px;">Yes, restore</div> \
            <div class="setuptools link backups restoreCancelled menuStyle negative cfright" style="width: 150px;">Cancel</div> \
    ');
...
setuptools.app.backups.create = function(silent) {
    ...
    setuptools.lightbox.build('backups-create', ' \
        ...
        <br><br><span class="setuptools config download acknowledge">Right click and choose \'Save link as...\' to download.</span> \
        <br><br><div class="setuptools app" style="float: left; clear: both; width: 100%;">\
            <input name="BackupCustomName" placeholder="Custom Backup Name" style="float: left; clear: left; margin-right: 5px;"> \
    ...
    var Process = function(self) {
        ...
        self.html('<span class="success" style="margin: 0;">Saved!</span>');
