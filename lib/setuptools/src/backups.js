    ...
    if ( BackupList.length === 0 ) {
        ...
        setuptools.lightbox.build('backups-index', ' \
                ...
                <div class="cfleft" style="width: 100%;">\
                    <div class="cfleft" style="margin-right: 5px; width: 100%;">\
                        <select name="BackupName" class="setting" style="width: 100%;">\
        ');
        ...
        setuptools.lightbox.build('backups-index', ' \
                    ...
                    <div class="cfleft" style="margin-top: 10px;"> \
                        ...
                        <div class="setuptools link backups delete menuStyle negative noclose" title="Delete Backup" style="width: 70px; text-align: center;">Delete</div> \
                    </div> \
                </div>\
            </div> \
        ');
