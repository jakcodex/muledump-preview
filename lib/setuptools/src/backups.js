        ...
        afterOpen: function() {
            ...
            setuptools.app.backups.archive.create(function(content, name) {
                ...
                setuptools.lightbox.build('backups-archive-download', ' \
                    An archive backup includes both a Muledump backup and all account data cache downloaded from ROTMG servers. \
                    <br>&nbsp;\
                    <br>Archive backups are not stored in your browser due to their size.\
                    <br>&nbsp;\
                    <br>If the download doesn\'t start then <a href="#" class="setuptools link download noclose">click here</a> to manually download the file.\
                ');
 ...
 * @param {function} [callback]
 * Create a backup archive that includes the SetupTools backup and account data
 */
