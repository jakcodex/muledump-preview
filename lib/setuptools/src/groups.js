...
setuptools.app.groups.manager = function(group, open) {
    ...
    setuptools.lightbox.build('groups-manager', ' \
        <div style="float: left; clear: both;">\
            <div class="setuptools link groups add menuStyle cfleft" style="width: 100px; margin-right: 5px; text-align: center;">Create Group</div> \
            <div class="setuptools link groups enableAll toggle noclose menuStyle fleft" style="width: 100px; margin-right: 5px; text-align: center;">Enable All</div> \
            <div class="setuptools link groups disableAll toggle noclose menuStyle fleft" style="width: 100px; margin-right: 5px; text-align: center;">Disable All</div> \
        </div>\
    ...
    function OpenEditor(groupName, self) {
                    ...
                    var options = [
                        ...
                        },
                        {
                            ...
                            binding: function() {
                                ...
                                searchCell.parent().parent().parent().css({'padding-top': '5px', 'padding-bottom': '8px'});
        ...
        editor.html(' \
            ...
            <div class="setuptools groupSaveControls fleft" style="width: 100%; margin-top: 34px; clear: both;"> \
                ...
                <div class="setuptools revert group menuStyle negative fright" style="margin-right: 0;">Revert Changes</div> \
                \
                <div class="setuptools empty menuStyle cfleft">&nbsp;</div> \
                <div class="setuptools close group menuStyle negative fright" style="margin-top: 5px; margin-right: 0;">Close Editor</div> \
            </div>\
        ');
