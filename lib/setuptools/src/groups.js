        ...
        function OpenEditor(groupName, self) {
            ...
            var ListAccountTiles = function(groupName, page) {
                ...
                for ( i = minIndex; i < maxIndex; i++ )
                    html += '<div class="cell">' + availableAccountsList[i] + '</div>'
            ...
            function availableAccountsContext() {
                ...
                $('div.availableAccounts > div.dragbox > div.cell').click(function() {
                    ...
                    if ( $(this).hasClass('selected') === false ) {
                        ...
                        setuptools.lightbox.menu.context.create('Add to Group', position, options, self);
            ...
            var groupMemberPaginate = setuptools.lightbox.menu.paginate.create(
            ...
            editor.html(' \
                <div class="availableAccounts" style="height: ' + editorHeight + 'px;">\
                    ...
                    ' + groupMemberPaginate.html.menu + ' \
                    <div class="dragbox">' + ListAccountTiles(groupName) + '</div> \
                    ' + groupMemberPaginate.html.search + ' \
                </div> \
            ...
            //  bind editor buttons
            groupMemberPaginate.bind();

            //  bind availableAccounts actions
        ...
        $('.setuptools.div.groupControls div.groupMenu').click(function (e) {
            ...
            if (selectedCount === 1) {
                ...
                if ( $('.setuptools.div.groupControls div.groupMenu').hasClass('selected') === false ) {
                    ...
                    setuptools.lightbox.menu.context.create('Group - ' + groupName, position, options, self);
