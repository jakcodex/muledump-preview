...
setuptools.app.muledump.charsort.menu = function(guid, charlist) {
    ...
    if (
        ...
        //  character sorting gui
            ...
            setuptools.lightbox.build('muledump-charsort', ' \
                <div id="charField" class="charField flex-container noFlexAutoWidth scrollbar" style="height: 225px; overflow-y: scroll; flex-wrap: wrap; justify-content: flex-start;">' + portraitHtml + '</div> \
