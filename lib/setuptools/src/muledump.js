...
setuptools.app.muledump.whitebag.tracker = function(guid) {
    ...
    setuptools.lightbox.build('whitebag-totals', ' \
        <div class="wbmenu flex-container">\
            <div style="width: 45%; justify-content: flex-end;" class="flex-container mr5">\
                <select class="setuptools menuTiny" name="wbaction" style="width: 50%; height: 26px; text-align: center;">\
            ...
            <div style="width: 45%; justify-content: flex-start;" class="flex-container ml5"><div style="width: 50%; height: 26px;" class="muledump link go menuStyle notice menuTiny textCenter">Go</div></div>\
        </div>\
        <div class="wbmenu flex-container">\
            <div style="width: 45%; justify-content: flex-end;" class="flex-container mr5">\
                <select class="setuptools menuTiny" name="wbexport" style="width: 50%; height: 26px; text-align: center;">\
            ...
            <div style="width: 45%; justify-content: flex-start;" class="flex-container ml5"><div style="width: 50%; height: 26px;" class="muledump link export notice menuStyle menuTiny textCenter">Export</div></div>\
        </div>\
    ...
    $('div.muledump.link.go').on('click.wbmenu.go', function() {
        ...
        if ( action === 'reset' ) {
            ...
            setuptools.lightbox.build('whitebags-import', ' \
                ...
                \
                <div class="flex-container" style="justify-content: space-between; margin: 25px 0 0 0; flex-flow: column;">\
                    <div class="muledump link import keep menuStyle positive textCenter mb5 flex-container noFlexAutoWidth" style="justify-content: space-between;"><div>Import</div><div>Keep existing data</div></div>\
                    <div class="muledump link import clear menuStyle positive textCenter mb5 flex-container noFlexAutoWidth" style="justify-content: space-between;"><div>Import</div><div>Reset counters</div></div>\
                    <div class="muledump link import reset menuStyle positive textCenter mb5 flex-container noFlexAutoWidth" style="justify-content: space-between;"><div>Import</div><div>Reset counters and owned</div></div>\
