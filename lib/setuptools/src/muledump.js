        ...
        },
        {
            ...
            binding: function() {
                ...
                $('select.fameBonusFilter').change(function() {
                    ...
                    setuptools.data.options.fameamount = ( $(this).val() === -1 ) ?
                        setuptools.data.options.fameamount :
                        $(this).val();
        ...
        },
        {
            ...
            binding: function() {
                ...
                $('select.feedPowerFilter').change(function() {
                    ...
                    setuptools.data.options.feedpower = ( $(this).val() === -1 ) ?
                        setuptools.data.options.feedpower :
                        $(this).val();
...
setuptools.app.muledump.mulemenu = function(e, guid, context, track, extraopts) {
    ...
    //  add global options
    if ( setuptools.app.config.determineFormat(setuptools.data.accounts, 0) === true || setuptools.data.accounts.accounts[guid].loginOnly === false )options.push(
        {
            class: 'chsort',
...
setuptools.app.muledump.mulelink = function(guid) {
    ...
    //  does not support steam or testing
    if (
        guid.indexOf('steamworks:') === 0 ||
