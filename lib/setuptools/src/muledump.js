...
/* AffaSearch(TM) */
setuptools.app.muledump.affasearch = {
    state: {
        list: []
    }
};
...
setuptools.app.muledump.affasearch.init = function() {
    ...
    for ( var guid in Accounts ) {
        ...
        if ( Accounts.hasOwnProperty(guid) ) {
            ...
            setuptools.app.muledump.affasearch.state.list.push({
                username: guid,
    ...
    setuptools.app.muledump.affasearch.paginate = setuptools.lightbox.menu.paginate.create(
        setuptools.app.muledump.affasearch.state.list,
        undefined,
        'affasearch',
        undefined,
        undefined,
        undefined,
        {
            search: {
                ...
                keys: ['ign', 'username'],
                keyup: true,
                execute: setuptools.app.muledump.affasearch.execute,
                menuItem: 'link',
                skip: ['reposition']
            }
        }
    ...
    setuptools.lightbox.menu.search.bind(
        setuptools.app.muledump.affasearch.paginate,
        false,
        'div#affabutton',
        undefined,
        {
...
setuptools.app.muledump.affasearch.execute = function(state, searchTerm, skip) {

    console.log('affasearch execute', state, searchTerm, skip);
