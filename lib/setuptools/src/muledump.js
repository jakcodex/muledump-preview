...
setuptools.app.muledump.totals.menu.basic = function(track) {
...
setuptools.app.muledump.totals.config.getKey = function(key, configSet, defaultValue) {
    ...
    if ( typeof setuptools.data.muledump.totals.configSets.settings[configSet] !== 'object' ) return defaultValue;
