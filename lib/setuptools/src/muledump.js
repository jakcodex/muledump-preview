        ...
        if ( action === 'reset' ) {
            ...
            setuptools.lightbox.build('whitebags-import', ' \
                ...
                <div class="flex-container" style="justify-content: space-between; margin: 25px 0 0 0; flex-flow: column;">\
                    ...
                    <div class="muledump link import keep menuStyle notice textCenter mb5 flex-container noFlexAutoWidth" style="justify-content: space-between;"><div>Import</div><div>Keep existing data</div></div>\
