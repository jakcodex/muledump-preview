...
setuptools.app.muledump.realmeye.itemCtrlUp = function(e) {
    ...
    if ( selected.length === 1 ) {
        ...
        if ( setuptools.config.realmeyeTradingIds.indexOf(Number($(selected[0]).attr('data-itemid'))) > -1 ) options.push({
            option: 'link',
            name: 'Buy ' + item[0],
    ...
    //  trading menu
        ...
        var item = items[$(selected[0]).attr('data-itemid')];
        if (
            setuptools.config.realmeyeTradingIds.indexOf(Number($(selected[0]).attr('data-itemid'))) > -1 &&
            setuptools.config.realmeyeTradingIds.indexOf(Number($(selected[1]).attr('data-itemid'))) > -1
        ) {
            options.push({
                option: 'link',
