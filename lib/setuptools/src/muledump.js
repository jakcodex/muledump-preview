...
setuptools.app.muledump.ocl.manager = function(profile, advanced) {
    ...
    setuptools.lightbox.build('settings-ocl', ' \
        <div class="ocl switch flex-container" style="justify-content: flex-start; margin-bottom: 17px;">\
        ...
        <div class="ocl manager">\
            <div class="ocl configuration">\
                ...
                <div style="justify-content: flex-end;">\
                    ...
                    <div class="setuptools link ocl reset noclose menuStyle buttonStyle negative" style="width: 100px;">Reset</div>\
                    <div class="setuptools link ocl save noclose menuStyle buttonStyle positive mr0" style="width: 100px;">Save</div>\
                </div>\
            </div>\
    ...
    ');
    setuptools.lightbox.settitle('settings-ocl', 'One Click Login');
    setuptools.lightbox.drawhelp('settings-ocl', 'docs/setuptools/help/ocl', 'OCL Help');
    setuptools.lightbox.goback('settings-ocl', setuptools.app.index);
    setuptools.lightbox.display('settings-ocl', {variant: 'fl-SettingsLarge'});
