    ...
    function procRemote(type) {
        ...
        if ( type === 'image' ) {
            ...
            if ( image.length === 0 || (image.length === 1 && image.attr('src').match(/^https?:\/\/.*/) !== null) ) {
                ...
                if ( image.length === 0 ) $('div.exporter.status').html('<br>Uploading to Imgur...');
...
setuptools.app.muledump.ownedSkins = function(guid, tex1, tex2) {
    ...
    Object.filter(setuptools.tmp.skins[guid], function(classid, data) {
        ...
        var html = ' \
            <div style="background-color: #222; justify-content: flex-start; flex-wrap: wrap;" class="flex-container ownedSkins ' + classData[0] + '"> \
                ...
                <div class="skinlist" style="background-color: #222;">\
        ';
    ...
    setuptools.lightbox.build('wardrobe-index', ' \
        ...
        <div class="skinstage" style="background-color: #222;">\
    ');
