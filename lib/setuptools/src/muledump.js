...
setuptools.app.muledump.ownedSkins = function(guid) {
    ...
    if ( typeof setuptools.tmp.skins[guid] !== 'object' ) {
        ...
        Object.filter(skins, function(skinid, data) {
            if ( [65535].indexOf(data[4]) > -1 || data[0].match(/^.*? Set(?: Skin)?$/) !== null ) {
                //count.total++;
                return;
            }
    ...
    Object.filter(setuptools.tmp.skins[guid], function(classid, data) {
        ...
        var html = ' \
            <div style="background-color: #212121; justify-content: flex-start; flex-wrap: wrap;" class="flex-container ownedSkins ' + classData[0] + '"> \
                <div class="flex-container mb5" style="justify-content: space-between; padding: 5px; border: 2px solid #000000; background-color: #333;"> \
                    <div style="font-size: 14px;" id="class-' + classData[0] + '"><strong>' + classData[0] + '</strong></div>\
                    <div style="font-size: 14px; font-weight: bold;">[[' + classid + '_count]]</div>\
                </div>\
                <div class="skinlist" style="background-color: #212121;">\
        ';
    ...
    setuptools.lightbox.build('wardrobe-index', ' \
        ...
        <div class="skinstage" style="background-color: #212121;">\
    ');
    ...
    Object.keys(classes).filter(function(classid) {
        ...
        window.portrait($s, classid, classid, undefined, undefined, false);
        setuptools.app.muledump.tooltip($s, 'ownedSkinsTooltip skinmenu', '<div style="padding: 5px 10px; color: #fff;">' + classes[classid][0] + '</div>', 100);
