 ...
 */
setuptools.app.muledump.tooltip = function($i, classes, content) {
    ...
    $i.off('mouseenter.muledump.tooltip').on('mouseenter.muledump.tooltip', function(e) {
        ...
        setuptools.tmp.tstateOpen = setTimeout(((typeof content === 'string') ? contentCallback : defaultCallback), setuptools.data.config.tooltip, self);
...
setuptools.app.muledump.ownedSkins = function(guid) {
    ...
    if ( typeof setuptools.tmp.skins !== 'object' ) {
        ...
        Object.filter(skins, function(skinid, data) {
            if ( [65535].indexOf(data[4]) > -1 ) return;
