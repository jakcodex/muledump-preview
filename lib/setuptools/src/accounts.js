...
setuptools.app.accounts.manager = function() {
    ...
    function AccountsListUpdate(direction) {
        ...
        $('div.AccountsList.list').html(' \
            ...
            ' + ( (AccountsPaginate.lastPage > 0) ? '<div class="controller enableAll" style="margin-top: 5px; clear: left; margin-right: 5px;">Enable All</div>' : '' ) + ' \
            ' + ( (AccountsPaginate.lastPage > 0) ? '<div class="controller disableAll" style="margin-top: 5px; clear: right;">Disable All</div>' : '' ) + ' \
        ');
            ...
            if ( name === 'accountMenu' ) {
                ...
                var options = [
                    ...
                    },
                    {
                        ...
                        callback: function(listPos) {
                            setuptools.app.accounts.ExportDeepCopyDirect(AccountsList[listPos].username);
                        },
                        callbackArg: listPos
                    },
                    {
    ...
    setuptools.lightbox.build('accounts-manager', ' \
        <div class="setuptools accounts editor">\
            ...
            <div class="AccountsList"> \
                ...
                <div class="controller newAccount">Add New Account</div> \
                \
                <div class="controller saveAccounts">Save Accounts <span id="changeStatus"></span></div> \
                <div class="controller importAccountsJS">Import Accounts.js...</div> \
                \
                <div class="controller empty" style="">&nbsp;</div> \
                ' + ( ( setuptools.state.loaded === true ) ? '<div class="controller exportAccountsJS">Export Accounts.js...</div>' : '' ) + ' \
            </div>\
        </div> \
    ');
...
setuptools.app.accounts.ExportDeepCopyDirect = function(guid) {
