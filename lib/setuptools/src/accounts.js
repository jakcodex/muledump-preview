...
setuptools.app.accounts.manager = function() {
    ...
    function createRow(listPos) {
        ...
        return ' \
            <div class="cell noselect" data-listPos="' + listPos + '"> \
                <div><input class="text" name="username" type="text" placeholder="Account Email or ID" value="' + AccountsList[listPos].username + '"></div> \
                <div><input class="text" name="password" type="password" placeholder="Account Password" value="' + AccountsList[listPos].password + '" data-reveal="false"></div> \
    ...
    function AccountsListUpdate(direction) {
        ...
        $('div.AccountsList.list').html(' \
            ...
            <div class="setuptools app list"' + ( (setuptools.state.firsttime === false || AccountsPaginate.lastPage > 0) ? ' style="height: ' + editorHeight + 'px;"' : '' ) + '>\
    ...
    function AccountsContext() {
        ...
        $('div.editor.control.massSwitch').unbind('click').click(function() {
            ...
            setuptools.lightbox.build('accounts-massSwitch', ' \
                ...
                \
                <div style="width: 100%;" class="massSwitch">\
                <div class="cfleft" style="margin-bottom: 5px; margin-right: 5px; margin-top: 3px; height: 24px;"><h3>All Accounts</h3></div> \
                <div class="setuptools link menuStyle negative menuTiny cfright noclose" data-key="enabled" data-value="false" style="margin-bottom: 5px;">Disable All</div> \
                <div class="setuptools link menuStyle menuTiny fright noclose" data-key="enabled" data-value="true" style="margin-bottom: 5px;">Enable All</div> \
                \
                <div class="cfleft" style="margin-bottom: 5px; margin-right: 5px; margin-top: 3px; height: 24px;"><h3>Account Data Cache</h3></div> \
                ...
                \
                <div class="cfleft" style="margin-bottom: 5px; margin-right: 5px; margin-top: 3px; height: 24px;"><h3>Account Auto Reload</h3></div> \
                ...
                \
                <div class="cfleft" style="margin-bottom: 5px; margin-right: 5px; margin-top: 3px; height: 24px;"><h3>Login Only Mode</h3></div> \
                <div class="setuptools link menuStyle negative menuTiny cfright noclose" data-key="loginOnly" data-value="false" style="margin-bottom: 5px;">Disable All</div> \
                <div class="setuptools link menuStyle menuTiny fright noclose" data-key="loginOnly" data-value="true" style="margin-bottom: 5px;">Enable All</div> \
                \
                </div>\
            ');

            setuptools.lightbox.settitle('accounts-massSwitch', 'Accounts Mass Switch');
            setuptools.lightbox.display('accounts-massSwitch', {variant: 'fl-AccountsSmall'});
            ...
            $('div.massSwitch > div.link').click(function() {
                ...
                $('.controller.notifier.saveNotice').removeClass('empty').addClass('notice').text('Don\'t forget to save changes').css({'cursor': 'initial'});
        ...
        $('div.setuptools.accountControls > div').unbind('click').click(function() {
            ...
            if ( name === 'accountMenu' ) {
                ...
                options.push({
                    ...
                    attributes: {
                        'data-clipboard-text': AccountsList[listPos].username
                    }
                },
                {
                    class: 'addCancel',
    ...
    $('div.AccountsList > div.controller').click(function() {
        ...
        if ( $(this).hasClass('saveAccounts') === true ) {
            ...
            for ( i = 0; i < AccountsList.length; i++ )
                if ( keys.indexOf(AccountsList[i]) === -1 )
...
setuptools.app.accounts.ExportDeepCopy = function(guid) {
...
setuptools.app.accounts.AccountsJSImport =  function() {
    ...
    setuptools.lightbox.build('accounts-accountsjs-index', ' \
        ...
        <br><br><div class="setuptools link enable menuStyle noclose fleft" style="clear: both; width: 150px;">' + ( (setuptools.data.config.enabled === true) ? 'SetupTools Enabled' : 'Enable SetupTools' ) + '</div> \
        <div style="float: left; clear: both; width: 100%; margin-top: 17px;"> \
    ');
    ...
    if ( Object.keys(setuptools.originalAccountsJS).length > 0 ) {
        ...
        setuptools.lightbox.build('accounts-accountsjs-index', ' \
            <div class="setuptools link import accountsJS ' + menuClass + ' fleft noclose" style="margin-right: 5px; width: 150px;">Import Accounts.js</div> \
            <div class="setuptools link import upload ' + menuClass + ' fright noclose" style="width: 150px;">Upload Accounts.js</div> \
        ');

    } else {

        setuptools.lightbox.build('accounts-accountsjs-index', ' \
            <div class="setuptools link import upload ' + menuClass + ' fleft noclose" style="width: 150px;">Upload Accounts.js</div> \
        ');
...
setuptools.app.accounts.AccountsJSImportLocal = function() {
    ...
    if ( FoundKeys > 0 ) {
        ...
        setuptools.lightbox.build('accounts-accountsjs-import', ' \
            ...
            <br><br><div class="setuptools link accounts importConfirmed menuStyle cfleft" style="width: 150px;">Review Import</div> \
            <div class="setuptools link accounts importCancelled menuStyle negative cfright" style="width: 150px;">Cancel</div> \
    ...
    setuptools.lightbox.display('accounts-accountsjs-import', {variant: 'fl-Index'});
...
setuptools.app.accounts.AccountsJSImportUpload = function(manual) {
    ...
    setuptools.lightbox.build('accounts-accountsjs-upload', ' \
        ...
        <div class="setuptools link uploadData save menuStyle cfright noclose" style=" margin-right: 0;">Select a File</div> \
    ');
    ...
    setuptools.lightbox.display('accounts-accountsjs-upload', {variant: 'fl-AccountsJSImportUpload'});
