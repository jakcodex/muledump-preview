    ...
    setuptools.lightbox.build('accounts-manager', ' \
        <div class="setuptools accounts editor">\
            ...
            <div class="AccountsList"> \
                ...
                \
                <div class="controller empty saveNotice menuStyle" style="">&nbsp;</div> \
                ' + ( ( setuptools.state.loaded === true ) ? '<div class="controller exportAccountsJS menuStyle">Export Accounts.js...</div>' : '' ) + ' \
            </div>\
        </div> \
    ');
...
setuptools.app.accounts.AccountsJSImportUpload = function(manual) {
    ...
    setuptools.lightbox.build('accounts-accountsjs-upload', ' \
        ...
        <div class="setuptools link uploadData save menuStyle cfright noclose">Select a File</div> \
    ');
