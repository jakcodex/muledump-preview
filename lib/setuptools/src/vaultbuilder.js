...
setuptools.app.muledump.vaultbuilder.ui = function(layout, guid) {
    ...
    setuptools.lightbox.build('vaultbuilder', ' \
        <div class="flex-container">\
            <div id="vaultbuilder" class="flex-container noFlexAutoWidth" style="flex-wrap: wrap; width: ' + (width+112) + 'px; min-width: 560px;"> \
                ...
                <div class="flex-container">\
                    <div class="flex-container uimenu" style="justify-content: space-evenly; width: 560px; height: 120px; background-color: #333; border: #555 solid 2px; padding: 10px; flex-wrap: wrap;">\
                        \
    ...
    setuptools.lightbox.goback('vaultbuilder', setuptools.app.devtools);
...
setuptools.app.muledump.vaultbuilder.tasks.load = function(layout, skipSave) {

    setuptools.data.muledump.vaultbuilder.config.layout = layout;
    if ( skipSave !== true ) setuptools.app.config.save('Muledump/VaultBuilder created duplicate', true);
...
setuptools.app.muledump.vaultbuilder.tasks.delete = function(layout) {
    ...
    layout = layout || setuptools.data.muledump.vaultbuilder.config.layout;
...
setuptools.app.muledump.vaultbuilder.menu.import = function(mode) {
    ...
    if ( mode === 'import' ) html += ' \
        ...
        \
        <div class="flex-container mb5 import layouts" style="flex-wrap: wrap;">\
        </div>\
        \
        <div class="flex-container">\
    ...
    options.push({
        ...
        binding: function() {
            ...
            $('div.setuptools.menu input[name="saveAsId"]').on('keydown.validateinput', setuptools.app.muledump.vaultbuilder.validateInput);
            ...
            function ImportFileParseZips(files) {
                ...
                Object.keys(files.layouts).forEach(function(layout) {
                    ...
                    var dom = $('<div class="flex-container mb5" data-layout="' + layout + '"> \
                        ...
                        <input value="' + files.layouts[layout].layoutname + '" type="text" name="name" placeholder="Layout ID Number" class="setuptools flex-container noFlexAutoWidth mr5" style="height: 17px; flex-grow: 1; width: 25%;">\
                        <input value="' + ( (+layout < setuptools.config.vaultbuilderMinimumId) ? '' : layout ) + '" type="text" name="layout" placeholder="' + ( (+layout < setuptools.config.vaultbuilderMinimumId) ? layout : 'Layout Name' ) + '" class="setuptools flex-container noFlexAutoWidth" style="height: 17px; flex-grow: 1; width: 25%;">\
                    </div>')
                        .css({display: 'none'})
                        .appendTo(container)
                        .slideDown();
                    ...
                    dom.find('input[name="layout"]').each(function(e) {
                        $(this).off('keydown.inputvalidation').on('keydown.inputvalidation', setuptools.app.muledump.vaultbuilder.validateInput);
    ...
    options.push({
        ...
        value: ' \
            <div class="flex-container" style="flex-wrap: wrap; justify-content: space-between;">\
                ...
                <div class="setuptools link vaultbuilder duplicateNew confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px;">Duplicate</div>\
                <div class="setuptools link vaultbuilder cancel confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px;">Cancel</div>\
            </div>\
        ',
        binding: function() {
    ...
    options.push({
        ...
        value: ' \
            <div class="flex-container" style="justify-content: space-between;">\
                ...
                <input name="createNewWidth" placeholder="Width" class="mb5" style="width: 66px; text-align: center;">\
                <input name="createNewHeight" placeholder="Rows" class="mb5" style="width: 66px; text-align: center;">\
                <div class="setuptools link vaultbuilder createNew confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px;">Create</div>\
                <div class="setuptools link vaultbuilder cancel confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px ">Cancel</div>\
            </div>\
        ',
        binding: function() {
    ...
    options.push({
        ...
        value: ' \
            <div class="flex-container" style="flex-wrap: wrap; justify-content: space-between;">\
                ...
                <div class="setuptools link vaultbuilder saveAs confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px;">Save</div>\
                <div class="setuptools link vaultbuilder cancel confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px;">Cancel</div>\
            </div>\
        ',
        binding: function() {
...
setuptools.app.muledump.vaultbuilder.menu.rename = function() {
    ...
    options.push({
        ...
        value: ' \
            <div class="flex-container" style="flex-wrap: wrap; justify-content: space-between;">\
                <input name="renameAs" placeholder="New Name" class="mb5" style="width: 100%; text-align: center; background-color: transparent; outline: 0; border: solid 2px #707070; padding: 4px; color: #ffffff;"> \
                <div class="setuptools link vaultbuilder renameAs confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px;">Save</div>\
                <div class="setuptools link vaultbuilder cancel confirm menuStyle buttonStyle menuSmall mr0" style="width: 68px; height: 17px;">Cancel</div>\
            </div>\
        ',
        binding: function() {
...
setuptools.app.muledump.vaultbuilder.menu.options = function() {
    ...
    if ( setuptools.data.muledump.vaultbuilder.config.layout >= setuptools.config.vaultbuilderMinimumId ) options.push({
        ...
        name: 'Delete',
        callback: setuptools.app.muledump.vaultbuilder.tasks.delete
    });
