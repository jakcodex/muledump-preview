    ...
    if ( manual === true || !lastBackup || (Date.now()-lastBackup >= (setuptools.data.config.backupAssistant*86400000)) ) {
        ...
        setuptools.lightbox.build('backup-assistant', ' \
            It is good practice to download a backup of your Muledump configuration from time-to-time.\
             \
            <br><br><div class="setuptools link downloadBackup menuStyle cfleft" style="width: 150px; text-align: center;">Download Latest Backup</div> \
            <div class="setuptools link cancel menuStyle negative cfright" style="width: 150px;">Cancel</div> \
            \
            <div style="float: left; clear: both;"><br>The backup assistant can be disabled in <a href="#" class="setuptools app link settingsmanager">Settings Manager</a>.</div> \
        ');
