...
setuptools.app.assistants.rendersupdate = function(data) {
    ...
    setuptools.lightbox.build('rendersupdate-assistant', ' \
        ...
        <div class="w100">\
            ...
            <div class="fleft"><span style="font-weight: bold;">' + data.currentRenders + '</span> <span class="generic text dark">(' + data.currentRendersDate.toLocaleString() + ')</span></div>\
        </div>\
        <div class="w100">\
            <div class="cfleft" style="width: 25%;"><strong>Latest Version</strong></div> \
            <div class="fleft"><span style="font-weight: bold;">' + data.latestRenders + '</span> <span class="generic text dark">(' + data.latestRendersDate.toLocaleString() + ')</span></div>\
        </div>\
        <br><br>&nbsp;\
        ...
        <br><br>Tired of having to update these files or Muledump yourself? Why not check out <a href="" target="_blank">Muledump Online</a>>?\
    ');
