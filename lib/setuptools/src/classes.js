    ...
    import(tracker, excluded) {
        ...
        if ( tracker instanceof Muledump_TotalsCounter &&
            ...
            if ( this.sources.indexOf(tracker.guid) > -1 ) {
                ...
                if ( excluded !== true && new SeaSalt_Hashing(JSON.stringify(this.sourceData[tracker.guid].meta), 'sha256', 'hex').toString() === new SeaSalt_Hashing(JSON.stringify(tracker.data.meta), 'sha256', 'hex').toString() ) {
                ...
                this.log('Muledump_TotalsCounter/Import mode 0');
            ...
            this.log('Muledump_TotalsCounter/Import mode 1');
        ...
        //  import mode 2: reimport of all tracker sources
            ...
            this.log('Muledump_TotalsCounter/Import mode 2');
            this.busy = true;
            this.aggregate = true;
            this.excluded = [];
            tracker = [];
