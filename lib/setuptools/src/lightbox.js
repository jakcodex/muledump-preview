        ...
        if (options.hasOwnProperty(i)) {
            ...
            if (!options[i].option) {
                ...
                //  create an actual link
                    ...
                    html += '<div class="link"><a href="' + options[i].href + '" class="setuptools menuLink ' + options[i].class + '" target="_blank" ' + featherlightAttr + '><div class="w100 h100">' + options[i].name + '</div></a></div>\n';
