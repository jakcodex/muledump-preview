...
setuptools.app.ga = function(command, action, value1, value2, value3, value4, value5) {
    ...
    if (
        ...
        ( action === 'event' && [
            'nonJakcodexCORS', 'isJakcodexCORS', 'mqAccountFinish', 'newUserSetup'
...
setuptools.app.help = function() {
    ...
    setuptools.lightbox.build('help', ' \
        ...
        <ol>\
            ...
            <li><a href="' + setuptools.config.wikiUrl + '/Installation-and-Setup-Guide" target="_blank">Installation and Setup Guide</a></li> \
        ...
        <ol>\
            ...
            <li>Shift+Click a mule to add or remove it from the Account Filter</li>\
        ...
        <ol> \
            ...
            <li>Shift+Click an item to add it to the Hidden Items Filter</li>\
        </ol>\
        <ol> \
            ...
            <li>Click and Drag items to sort them in Item Group Sorting section</li>\
    ...
    setuptools.lightbox.display('help', {variant: 'fl-AccountsManager'});
