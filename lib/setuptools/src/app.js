...
setuptools.app.ga = function(command, action, value1, value2, value3, value4, value5) {
    ...
    if ( typeof ga !== 'function' || setuptools.state.hosted === false || setuptools.data.config.ga === false ) return;
    ...
    if ( typeof ga === 'function' ) ga(command, action, value1, value2, value3, value4, value5);
