...
setuptools.app.ga = function(command, action, value1, value2, value3, value4, value5) {
    ...
    if ( (!command && typeof analytics !== 'function') && setuptools.state.hosted === true && setuptools.data.config.ga === true ) {
    ...
    //  only for users with analytics enabled
    if ( setuptools.data.config.ga === false ) return;

    //  run any additional commands
    if ( typeof analytics === 'function' ) analytics(command, action, value1, value2, value3, value4, value5);
