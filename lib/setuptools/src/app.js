    ...
    if ( setuptools.app.checknew() === true ) {
        ...
        setuptools.lightbox.build('main', ' \
            <div style="width: 100%; text-align: center;">\
                ...
                <br><br>\
                <div class="setuptools link accounts manage menuStyle cfleft" style="width: 150px; margin-right: 5px; margin-bottom: 5px;">Accounts</div> \
                <div class="setuptools link accounts groups menuStyle cfright" style="width: 150px; margin-bottom: 5px;">Groups</div> \
                <div class="setuptools link config settings menuStyle notice cfleft" style="width: 150px; margin-right: 5px;">Settings</div> \
                <div class="setuptools link config backup menuStyle notice cfright" style="width: 150px;">Backups</div> \
            </div> \
        ');
