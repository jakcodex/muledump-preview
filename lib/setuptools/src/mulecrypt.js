...
setuptools.app.mulecrypt.init = function(callback) {
    ...
    window.sodium = {
        ...
        onload: function () {
            ...
            //  an object here means encryption is enabled
            if (
            ...
            //  no encryption; run the callback to load muledump
                ...
                callback();  //  honestly, it's formatted this way to see if Batman is paying attention
...
setuptools.app.mulecrypt.ui.index = function() {
    ...
    if ( setuptools.state.encryption.sodium === false ) {
