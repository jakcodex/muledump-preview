...
setuptools.app.config.settings = function(highlight, section) {
    ...
    setuptools.lightbox.build('settings', ' \
        <div class="Settings-Menu fleft cboth" style="margin-bottom: 16px;">\
            <div class="setuptools link switchSettings muledump menuStyle cfleft noclose">Muledump</div> \
            <div class="setuptools link switchSettings settings menuStyle fleft noclose">SetupTools</div> \
            <div class="setuptools link switchSettings assistants menuStyle fleft noclose">Assistants</div> \
            <div class="setuptools link switchSettings system menuStyle fleft noclose mr0">System</div> \
        </div>\
        \
    ...
    setuptools.lightbox.build('settings', ' \
            ...
            <div class="setuptools app config settings"> \
                <div id="settings-prices">Price Display in Tooltips</div> \
    ...
    $('.setuptools.link.config.settings.action.destroy').click(function() {
        ...
        $('.setuptools.app.config.settings select').each(function() {
            ...
            if ( ['enabled', 'preventAutoDownload', 'automaticBackups', 'debugging', 'ga'].indexOf(name) > -1 ) {
                ...
                //  these settings are integers in the config
                    ...
                    'backupAssistant', 'groupsMergeMode', 'autoReloadDays', 'totalswidth'
                ].indexOf(name) > -1 ) {
