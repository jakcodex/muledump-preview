 ...
 */
setuptools.app.config.userDelete = function(username) {

    console.log('Deleting bad account ' + username);
    return false;
    if ( setuptools.state.loaded === true && setuptools.data.accounts.accounts[username] ) {

        delete setuptools.data.accounts.accounts[username];
        setuptools.app.config.save('SetupTools/Config user delete', true);
        return true;
