...
setuptools.app.config.settings = function(highlight, section) {
    ...
    var sections = {
        muledump: ['accountLoadDelay', 'rowlength', 'errors', 'mulelogin', 'giftChestWidth', 'muleMenu', 'pagesearch', 'totalswidth', 'nomasonry'],
        settings: ['enabled', 'accountsPerPage', 'animations', 'autocomplete', 'automaticBackups', 'autoReloadDays', 'alertNewVersion', 'debugging', 'groupsMergeMode', 'hideHeaderText', 'lazySave', 'longpress', 'lowStorageSpace', 'maximumBackupCount', 'menuPosition', 'preventAutoDownload'],
