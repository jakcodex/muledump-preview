...
setuptools.app.config.settings = function(highlight, section) {
    ...
    setuptools.lightbox.build('settings', ' \
        <div style="margin-bottom: 16px; float: left; clear: both;">\
            <div class="setuptools link switchSettings muledump menuStyle cfleft noclose" style="width: 108px; margin-right: 5px; text-align: center;">Muledump</div> \
            <div class="setuptools link switchSettings settings menuStyle fleft noclose" style="width: 108px; margin-right: 5px; text-align: center;">SetupTools</div> \
            <div class="setuptools link switchSettings assistants menuStyle fleft noclose" style="width: 108px; margin-right: 5px; text-align: center;">Assistants</div> \
            <div class="setuptools link switchSettings system menuStyle fleft noclose" style="width: 108px; text-align: center;">System</div> \
        </div>\
        \
    ...
    setuptools.lightbox.build('settings', ' \
        ...
        <div class="setuptools containerSettings system' + ( (section !== 'system') ? ' hidden' : '' ) + '"> \
            <h3>System Data</h3> \
            <div class="setuptools link config settings action arrrrgbaaad menuStyle negative cfleft noclose" style="margin-top: 5px;">Erase SetupTools</div> \
            <div class="setuptools link config settings action eraseCache menuStyle negative cfleft noclose" style="margin-top: 5px;">Erase Cached Data</div> \
            <div class="setuptools link config settings action eraseAll menuStyle negative cfleft noclose" style="margin-top: 5px;">Erase All Data</div> \
        </div> \
    ');

    setuptools.lightbox.build('settings', ' \
            <div class="setuptools link config settings action destroy menuStyle negative cfleft noclose" style="margin-top: 5px;">Reset to Default Settings</div>\
        </div> \
    ');
