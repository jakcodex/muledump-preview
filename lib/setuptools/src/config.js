...
setuptools.app.config.settings = function(highlight, section) {
    ...
    var sections = {
        ...
        advanced: ['alertNewVersion', 'animations', 'autocomplete', 'automaticBackups', 'compression', 'debugging', 'lazySave', 'longpress', 'lowStorageSpace', 'preventAutoDownload', 'timesync'],
    ...
    setuptools.lightbox.build('settings', ' \
        <div class="Settings-Menu fleft cboth flex-container" style="flex-wrap: wrap; margin-bottom: 16px;">\
            ...
            <div class="setuptools link switchSettings advanced menuStyle fleft noclose ml5 mb5">Advanced</div> \
        ...
        $('.setuptools.app.config.settings select').each(function() {
            ...
            if ( [
                ...
                //  these settings are integers in the config
                    ...
                    'lazySave', 'totalsExportWidth', 'exportDefault', 'keyBindings'
                ].indexOf(name) > -1 ) {
