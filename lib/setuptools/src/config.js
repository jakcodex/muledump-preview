    ...
    if ( setuptools.state.hosted === false ) {
        ...
        setuptools.lightbox.build('settings', ' \
            ...
            <div style="margin: 15px 25px;">\
                Usage Analytics provides anonymous information using Google Analytics to help improve the quality and features in Muledump. You can read more about the collected data at the <a href="https://github.com/jakcodex/muledump/wiki/Usage+Analytics">Usage Analytics</a> wiki page.\
            </div> \
            <div class="setuptools app config settings"> \
