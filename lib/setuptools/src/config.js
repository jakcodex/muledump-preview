...
setuptools.app.config.settings = function(highlight, section) {
    ...
    var sections = {
        ...
        settings: ['enabled', 'accountsPerPage', 'animations', 'automaticBackups', 'alertNewVersion', 'autoReloadDays', 'debugging', 'groupsMergeMode', 'loginOnlyTotals', 'longpress', 'maximumBackupCount', 'menuPosition', 'preventAutoDownload'],
