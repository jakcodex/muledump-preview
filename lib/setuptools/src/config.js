...
setuptools.app.config.settings = function(highlight, section) {
    ...
    setuptools.lightbox.build('settings', ' \
        <div style="margin-bottom: 16px; float: left; clear: both;">\
            ...
            <div class="setuptools link switchSettings system menuStyle fleft noclose" style="width: 108px; text-align: center; margin-right: 0;">System</div> \
        </div>\
        \
    ...
    if ( setuptools.data.config.enabled === true ) {
        ...
        setuptools.lightbox.build('settings', ' \
                ...
                <div class="setuptools app config settings"> \
                    <div>Automatically Reload Account Data</div> \
                    <select name="autoReloadDays" class="setting"> \
                        <option value="0">Off</option> \
        ');

        for (i = 1; i <= 7; i++) setuptools.lightbox.build('settings', ' \
    ...
    $('.setuptools.link.config.settings.action.eraseCache').click(function() {
        ...
        setuptools.lightbox.build('settings-eraseCache-confirm', ' \
            ...
            <br><br>Are you sure? \
            <br><br><div class="setuptools link eraseCache confirm menuStyle negative cfleft" style="width: 150px;">Yes, erase</div>\
            <div class="setuptools link cancelBadThing menuStyle cfright" style="width: 150px;">No, cancel</div> \
        ');
    ...
    $('.setuptools.link.config.settings.action.arrrrgbaaad').click(function() {
        ...
        setuptools.lightbox.build('settings-erase-confirm', ' \
            ...
            <div class="setuptools link cancelBadThing menuStyle cfright menuSmall">No, cancel</div> \
            <div style="float: left; clear: both;"><br><input type="checkbox" name="clearBackups"> Erase backups stored in your browser</div> \
        ');
