...
setuptools.app.config.settings = function(highlight) {
    ...
    setuptools.lightbox.build('settings', ' \
        ...
        \
        <div class="setuptools containerSettings muledump">\
    ...
    setuptools.lightbox.build('settings', ' \
        ...
        \
        <div class="setuptools containerSettings settings hidden"> \
    ...
    if ( setuptools.data.config.enabled === true ) {
        ...
        setuptools.lightbox.build('settings', ' \
                ...
                \
                <div class="setuptools containerSettings assistants hidden"> \
    ...
    $('.setuptools.link.switchSettings').click(function() {
        ...
        console.log($(this).hasClass('muledump'), $(this).hasClass('setuptools'));
        var switchTo = false;
...
setuptools.app.config.backupAssistant = function() {
    ...
    if ( setuptools.data.config.backupAssistant === 0 ) return;
