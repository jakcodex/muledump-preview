        ...
        function ProcessResponse(data) {
            ...
            for (var i = 0; i < d.length; i++) {
                ...
                if ( latestRenders > currentRenders ) setuptools.app.muledump.notices.add(
                    'New renders update available',
                    function(d, i, rendersData, currentRenders, latestRenders) {
                        var arg = $.extend(true, [], d[i], rendersData, {currentRenders: currentRenders, latestRenders: latestRenders});
                        setuptools.app.assistants.rendersupdate(arg);
                    },
                    [d, i, rendersData, currentRenders, latestRenders]
                );
