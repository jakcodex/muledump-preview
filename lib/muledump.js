...
// document load
    ...
    $(function() {
        ...
        //  mulequeue menu
        $('#mulequeue').click(setuptools.app.mulequeue.menu);

            /*function() {



            //  v1 code no longer in use
            //  pause the queue
            if ( window.MuleQueue.running === true && window.MuleQueue.pause === false ) {
                ...
                window.techlog("MuleQueue/QueuePause " + window.MuleQueue.paused + " requests (running requests will finish)", 'force');
                ...
                window.techlog("MuleQueue/QueueCancelled " + window.MuleQueue.cancelled + " requests (running requests will finish)", 'force');
                $('#resume').hide();
