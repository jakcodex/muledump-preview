...
setuptools.app.config.settings = function(highlight) {
    ...
    $('.setuptools.app.config.settings.action.destroy').click(function() {
        ...
        $('.setuptools.app.config.settings select').each(function() {
            ...
            } else if ( ['maximumBackupCount', 'rowlength', 'nomasonry', 'accountLoadDelay', 'testing', 'prices', 'mulelogin', 'alertNewVersion', 'menuPosition', 'corsAssistant', 'accountAssistant'].indexOf(name) > -1 ) {
...
setuptools.app.muledump.accountAssistant = function(url, extraopts, callback) {
