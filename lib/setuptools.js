...
setuptools.app.muledump.loadOptions = function() {
    ...
    if ( setuptools.config.devForcePoint != 'loadOptions-hosted' || setuptools.state.hosted === false ) {

        window.options.updatecheck = true;
        window.options_layout.updatecheck = 'auto check for updates';
        window.globalopts.updatecheck = 1;
