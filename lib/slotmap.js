...
var itemsSlotTypeMap = {
    ...
    unlockers: {
        ...
        name: new RegExp(/^((?!Snowball|Paddy's Flying Hat|Rainbow Clover|(?:Small|Large) Firecracker).*)$/i),
        tier: -1,
        bagType: [2, 6],
        soulbound: true,
        include: new RegExp(/^(?:Backpack|Santa's Bag|Char Slot Unlocker|Vault Chest Unlocker)$/i)
    },
    eventitems: {
        sheet: [480, 40],
    ...
    wakis: {slotType: 27, sheet: [840, 40]}
};
