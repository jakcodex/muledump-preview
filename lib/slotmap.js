...
var itemsSlotTypeMap = {
    ...
    helpfulconsumables: {
        ...
        name: new RegExp(/^((?!snowball|.* firecracker|Backpack|Santa's Bag).*)$/i),
        tier: -1,
        bagType: 2,
        include: new RegExp(/^(?:Santa's Sleigh|Egg Nog|Fruitcake|Candy Cane|Figgy Pudding|Mistletoe|Elixir of .*|Effusion of .*)$/i)
    },
    otherconsumables: {
        sheet: [360, 40],
        displayName: 'Other',
        ...
        bagType: [2, 6],
        soulbound: true,
        include: new RegExp(/^(?:Backpack|Santa's Bag|Char Slot Unlocker|Vault Chest Unlocker|Mark of .*)$/i)
    },
    eventitems: {
        sheet: [480, 40],
    ...
    petfood: {
        ...
        name: new RegExp(/^((?!Apple of Semi Maxening|Level Chicken|Snowball|Valentine Launcher|Treasure Map|Beach Ball|Level 20 Unlocker).)*$/i),
        slotType: 10,
        tier: -1,
        bagType: 8,
        feedPower: {
