        ...
        if ( this.loginOnly === false ) {
            ...
            if (this.opt('accountinfo')) {
                ...
                $('<div class="stats">\
                    ...
                    <div class="flex-container"><div>Current Account Gold</div><div>' + this.data.query.results.Chars.Account.Credits + '</div></div> \
                    ...
                    <div class="flex-container"><div>Total Characters Slots</div><div>' + ( (data.query.results.other) ? data.query.results.other.maxCharNum : 'N/A' ) + '</div></div> \
