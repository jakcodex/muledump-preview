...
// Mule object
    ...
    var Mule = function(guid) {
        ...
        this.dom.on('click.muledump.disableMule', function(e) {
            ...
            if ( error = xml.match(/^<Error\/?>(.*?)<\/?Error>$/) ) {
                ...
                if ( error[1] === 'Account credentials not valid' ) {
                    ...
                    if ( [2,5].indexOf(setuptools.data.config.badaccounts) > -1 ) {
                        errOpts.action = 'removeall';
                        setuptools.app.config.userDelete(self.guid);
                    }
                    ...
                    //  delete invalid accounts
                    if ( [3,5].indexOf(setuptools.data.config.badaccounts) > -1 ) setuptools.app.config.userDelete(self.guid);
