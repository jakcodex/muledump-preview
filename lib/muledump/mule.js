...
// Mule object
    ...
    var Mule = function(guid) {
        ...
        this.dom.on('click.muledump.mule', function(e) {
            ...
            if (
                typeof setuptools.app.muledump.totals.config.getKey('accountFilter') === 'undefined'
            ) setuptools.app.muledump.totals.config.setKey(
                'accountFilter',
                setuptools.copy.data.config.totalsKeyObjects.accountFilter
            );
