...
// Mule object
    ...
    var Mule = function(guid) {
        ...
        this.totals = new Muledump_TotalsCounter(this.guid, true, function(self) {
            ...
            if (
                ...
                (typeof self === 'object' && typeof self.guid === 'string' && setuptools.data.muledump.totals.accountFilter.indexOf(self.guid) > -1)
    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
        ...
        if ( skipCacheWrite !== true ) this.totals = new Muledump_TotalsCounter(this.guid, false, function(self) {
            if (
                setuptools.data.muledump.totals.accountFilter.length === 0 ||
                setuptools.data.muledump.totals.accountFilter.indexOf(self.guid) > -1
            ) setuptools.tmp.globalTotalsCounter.import(self);
        });
