    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
        ...
        for (var i = 0; i < carr.length; i++) {
            ...
            */
            ...
            if ( setuptools.data.config.debugging === true ) timing['mule-parseWawawa-' + self.guid] = {
        ...
        if ( setuptools.data.config.debugging === true ) timing['mule-parseMainCharacterLoop-' + self.guid] = {
