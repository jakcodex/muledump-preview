    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
        ...
        for (var i = 0; i < carr.length; i++) {
            ...
            */
            ...
            timing['mule-parseWawawa-' + self.guid] = {
        ...
        timing['mule-parseMainCharacterLoop-' + self.guid] = {
        ...
        if (this.opt('vaults')) {
            ...
            setuptools.app.uaTimer('mule', 'parseVaults', 'start', this.guid + i);
            ...
            setuptools.app.uaTimer('mule', 'parseVaults', 'stop', this.guid + i);
        ...
        if (this.opt('gifts')) {
            ...
            setuptools.app.uaTimer('mule', 'parseGifts', 'start', this.guid + i);
            ...
            setuptools.app.uaTimer('mule', 'parseGifts', 'stop', this.guid + i);
