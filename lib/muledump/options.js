...
//  generate our list of available vault layouts from the default list
    ...
    var globalopts = { 'totals': 1, 'famefilter': 1, 'feedfilter': 1, 'sbfilter': 1, 'nonsbfilter': 1, 'utfilter': 1, 'stfilter': 1 };
    ...
    function option_updated(o) {
        ...
        if (['famefilter', 'fameamount', 'feedfilter', 'feedpower', 'utfilter', 'sbfilter', 'nonsbfilter', 'stfilter'].indexOf(o) > -1 ) {
            window.update_totals();
        }
        if (!(o in globalopts)) {
