(function($, window) {
    ...
    var options = {
        ...
        utfilter: false,
        stfilter: false,
        totalsTypesWeapons: true,
        totalsTypesAbilities: true,
        totalsTypesArmor: true,
        totalsTypesRings: true,
        totalsTypesPotions: true,
        totalsTypesKeys: true,
        totalsTypesSkins: true,
        totalsTypesTextiles: true,
        totalsTypesSwords: true,
        totalsTypesDaggers: true,
        totalsTypesBows: true,
        totalsTypesTomes: true,
        totalsTypesShields: true,
        totalsTypesLightArmor: true,
        totalsTypesHeavyArmor: true,
        totalsTypesWands: true,
        totalsTypesSpells: true,
        totalsTypesSeals: true,
        totalsTypesCloaks: true,
        totalsTypesRobes: true,
        totalsTypesQuivers: true,
        totalsTypesHelms: true,
        totalsTypesPoisons: true,
        totalsTypesStaves: true,
        totalsTypesSkulls: true,
        totalsTypesTraps: true,
        totalsTypesOrbs: true,
        totalsTypesPrisms: true,
        totalsTypesScepters: true,
        totalsTypesKatanas: true,
        totalsTypesStars: true,
        totalsTypesStatBoosters: true,
        totalsTypesDrakeEggs: true,
        totalsTypesEggs: true
    };
...
//  generate our list of available vault layouts from the default list
    ...
    function option_updated(o) {
        ...
        if (o === 'equipment' || o === 'inv' || o === 'vaults' || o === 'gifts' || o === 'backpack' ) {
