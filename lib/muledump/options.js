...
//  generate our list of available vault layouts from the default list
    ...
    function options_init() {
        ...
        */
        ...
        $('#options').unbind('mouseenter.options.display mouseleave.options.display').hover(function() {
        ...
        $('.handle.options').unbind('mouseenter.handleoptions.display mouseleave.handleoptions.display').hover(function() {
