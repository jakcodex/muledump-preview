...
//  8 - wands
//  9 - rings
//  10 - potions (tier 2, bagtype 5)
//  10 - potions soulbound (tier -1, bagtype 5)
//  10 - skins (tier -1, bagtype 8, fp > 200)
//  10 - dyes/cloths - (tier -1, bagtype 8, fb 0, soulbound)
//  10 - inc - (tier -1, bagtype 8, not soulbound)
//  10 - dyes/cloths (tier -1, bagtype 8, fp 0)
//  10 - greater/minor hpmp (tier -1, bagtype 0)
//  10 - hpmp (tier 1, bagtype 0)
//  10 - alcohol (tier 3, bagtype 2)
//  10 - elixers/tinctures/pirate rum/shrooms/coral juice (tier -1, bagtype 2, soulbound)
//  10 - drake eggs (tier -1, bagtype 2, not soulbound)
//  10 - effusions (tier -1, bagtype 5)
//  ^^^^^really rotmg???^^^^^
//  11 - spells
//  12 - seals
//  13 - cloaks
