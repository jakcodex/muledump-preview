...
function init_totals() {
	setuptools.app.uaTimer('totals', 'init', 'start');
	for (var id in items) {
    ...
    setuptools.app.uaTimer('totals', 'init', 'stop');
}
...
function update_totals() {
	...
	// count items
	setuptools.app.uaTimer('totals', 'update', 'start');
	for (var i in mules) {
    ...
    setuptools.app.uaTimer('totals', 'update', 'stop');
