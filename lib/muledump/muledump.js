        ...
        (function ($, window) {
            ...
            $(function () {
                ...
                if ( setuptools.state.preview === false ) {
                    var state = 'Local';
                    if ( setuptools.state.hosted === true ) state = 'Online';
                    if ( setuptools.browser === 'electron' ) state = 'Desktop ' + state;
                    $('#intro > .version').html('Jakcodex / Muledump ' + state + ' <span style="color: #90ccff;">v' + setuptools.version.major + '.' + setuptools.version.minor + '.' + setuptools.version.patch + '</span>');
                } else {
