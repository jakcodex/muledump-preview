...
// update everything with single option
    ...
    function options_init(hosted) {
        ...
        $('#accopts')
            .on('mouseleave', function() { console.log('accleave'); setuptools.tmp.accoptsMouseLeaveTimer = setTimeout(function(self) { $(self).hide(); }, 300, this); })
            .on('mouseenter', function() { console.log('accclear'); clearTimeout(setuptools.tmp.accoptsMouseLeaveTimer); });
